 ...
 *
 ******************************************************************************/
void SC_API_aes_init_keygen_tables(void) {
 ...
 *
 ******************************************************************************/
int SC_API_aes_set_encryption_key(aes_context* ctx, const uchar* key, uint keysize) {
 ...
 *
 ******************************************************************************/
int SC_API_aes_set_decryption_key(aes_context* ctx, const uchar* key, uint keysize) {
    int i, j;
    ...
    if ((ret = SC_API_aes_set_encryption_key(&cty, key, keysize)) != 0) return (ret);
 ...
 *
 ******************************************************************************/
int SC_API_aes_setkey(aes_context* ctx,   // AES context provided by our caller
...
#endif /* AES_DECRYPTION */
        return (SC_API_aes_set_encryption_key(ctx, key, keysize));
}
 ...
 *
 ******************************************************************************/
int SC_API_aes_cipher(aes_context* ctx, const uchar input[16], uchar output[16]) {
    int i;
